...
public class GuiAdminChest extends GuiContainer {
	...
	public GuiAdminChest(InventoryPlayer invPlayer,
	...
	private static final ResourceLocation texture = new ResourceLocation(
			"invchest", "textures/gui/adminChest.png");
	...
	public void initGui() {
		...
		buttonList.add(this.doneBtn = new GuiButton(1, guiLeft + 83,
				guiTop + 39, 32, 20, "Done"));

		// GuiTextField(FontRenderer, int xPos, int yPos, int width, int height)
		this.playerNameField = new GuiTextField(this.fontRenderer, 83, 20, 85,
				15);
		this.playerNameField.setMaxStringLength(32);
		this.playerNameField.setFocused(true);
		this.playerNameField.setText(this.adminChest.getPlayerName());// Need to
																		// request
																		// from
																		// server
	...
	protected void actionPerformed(GuiButton button) {
		if (button.enabled) {
			PacketHandler.sendPlayerNamePacket(playerNameField
					.getText());
		}
	}
