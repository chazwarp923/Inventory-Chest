...
public class PacketHandler implements IPacketHandler {
	...
	public void onPacketData(INetworkManager manager,
		...
		case 0:
			...
			if (container != null
					&& container instanceof ContainerInventoryChest) {
				TileEntityInventoryChest inventoryChest = ((ContainerInventoryChest) container)
						.getChest();
		...
		case 1:
			...
			if (container1 != null && container1 instanceof ContainerAdminChest) {
				TileEntityAdminChest adminChest = ((ContainerAdminChest) container1)
						.getChest();
	...
	public static void sendButtonPacket(byte id) {
		...
		try {
			...
			PacketDispatcher.sendPacketToServer(PacketDispatcher.getPacket(
					Reference.CHANNEL, byteStream.toByteArray()));
